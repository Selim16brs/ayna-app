...
const ITEMS: {
  ...
  },
  {
    ...
    descKey: 'seller.menu.reengage_d',
    route: '/seller/reengage',
    tone: 'accent',
  },
  {
    id: 'always',
    icon: 'infinite',
    labelKey: 'seller.menu.always',
    descKey: 'seller.menu.always_d',
    route: '/always',
    tone: 'lavender',
  },
  {
    ...
    descKey: 'seller.menu.services_d',
  ...
  },
  {
    id: 'gallery',
    icon: 'images',
    labelKey: 'reports.action.gallery',
    descKey: 'seller.menu.gallery_d',
    route: '/seller/gallery',
    tone: 'lavender',
  },
  {
    id: 'promotions',
    ...
    descKey: 'seller.menu.promotions_d',
  ...
  },
  {
    id: 'share',
    icon: 'share-social',
    labelKey: 'share.title',
    descKey: 'share.menu_d',
    route: '/seller/share',
    tone: 'accent',
  },
  // §10.1 — davet kodu üretici yalnız salonda
  {
    id: 'codes',
    icon: 'key',
    labelKey: 'reports.action.codes',
    descKey: 'seller.menu.codes_d',
    route: '/seller/codes',
    tone: 'lavender',
    salonOnly: true,
  },
