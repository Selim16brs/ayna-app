...
export const ISO_CEVIRME_KODU: Readonly<Record<string, string>> = {
  ...
  CU:'53', CV:'238', CW:'5999', CX:'61', CY:'357', CZ:'420', DE:'49', DJ:'253',
  ...
  IR:'98', IS:'354', IT:'39', JE:'44', JM:'1876', JO:'962', JP:'81', KE:'254',
  ...
  PM:'508', PN:'64', PR:'1787', PS:'970', PT:'351', PW:'680', PY:'595', QA:'974',
  RE:'262', RO:'40', RS:'381', RU:'7', RW:'250', SA:'966', SB:'677', SC:'248',
  SD:'249', SE:'46', SG:'65', SH:'290', SI:'386', SJ:'4779', SK:'421', SL:'232',
  SM:'378', SN:'221', SO:'252', SR:'597', SS:'211', ST:'239', SV:'503', SX:'1721',
  SY:'963', SZ:'268', TC:'1649', TD:'235', TG:'228', TH:'66', TJ:'992', TK:'690',
  TL:'670', TM:'993', TN:'216', TO:'676', TR:'90', TT:'1868', TV:'688', TW:'886',
  TZ:'255', UA:'380', UG:'256', US:'1', UY:'598', UZ:'998', VA:'3906698', VC:'1784',
 ...
 */
export function parcalaKesin(
  tam: string,
): { iso: string; kod: string; yerel: string } | null {
  const k = kutuphane();
