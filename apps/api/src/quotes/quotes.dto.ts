...
export const createQuoteRequestSchema = z.object({
  ...
  /**
   * Brief §4.5 — çoklu hizmet ("düğün paketi": hair.event_hair +
   * makeup.bridal + nails.gel_polish).
   *
   * Üst sınır 8: gerçek bir paket bu kadarını geçmiyor ve sınırsız liste
   * uzmana okunamayacak bir talep gösterirdi.
   */
  serviceIds: z.array(z.string().max(60)).max(8).optional(),
