...
export const tr = {
  ...
  'requests.give_premium': 'Premium ile teklif ver',
  'requests.premium_title': 'Yanıt vermek Premium’a özel',
  'requests.premium_body': 'Açık talepleri görebilirsin; teklif verebilmek için Premium’a geç.',
  'requests.premium_banner': 'Talepleri görüyorsun — yanıt vermek Premium ile açılır.',
